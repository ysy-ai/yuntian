...
<div style="height: 605px;width: 1000px;border: 1px solid silver;float: left;margin-left: 15px">
    ...
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;border-bottom: 1px silver solid">个人信息 账户设置</div>
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;border-bottom: 1px silver solid">
        头像${users1.headPortrait}

    </div>
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;border-bottom: 1px silver solid">
        <form action="/upload" method="post" enctype="multipart/form-data">
            选择文件:<input type="file" name="file" style="height: 50px;width: 120px"/><input type="submit" value="修改"/>
        </form>
    </form>
    </div>
    <form action="" method="post">
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;border-bottom: 1px silver solid">
        昵称　　<input type="text" name="username" value="${users.username}" style="height: 50px;width: 500px;margin-left: 20px;border-left: 1px silver solid"/><input type="submit" value="修改" style="border-radius: 20% 25% 25% 25%;width: 100px;height: 50px;margin-left: 50px;color: white"/>
    </div>
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;border-bottom: 1px silver solid">
        生日　　<input type="text" name="birthday" value="${users.birthday}" style="height: 50px;width: 500px;margin-left: 20px;border-left: 1px silver solid"/><input type="submit" value="修改" style="border-radius: 20% 25% 25% 25%;width: 100px;height: 50px;margin-left: 50px;color: white"/>
    </div>
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;border-bottom: 1px silver solid">
        换绑手机<input type="text" name="tel" value="${users.tel}" style="height: 50px;width: 500px;margin-left: 20px;border-left: 1px silver solid"/><input type="submit" value="修改" style="border-radius: 20% 25% 25% 25%;width: 100px;height: 50px;margin-left: 50px;color: white"/>
    </div>
    <div style="width: 750px;height: 100px;line-height: 100px;margin-left: 25px;">
        登录密码<input type="text" name="password" value="${users.password}" style="height: 50px;width: 500px;margin-left: 20px;border-left: 1px silver solid"/><input type="submit" value="修改" style="border-radius: 20% 25% 25% 25%;width: 100px;height: 50px;margin-left: 50px;color: white"/>
    </div>
    </form>
</div>
