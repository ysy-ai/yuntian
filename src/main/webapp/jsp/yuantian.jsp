...
<div style="height: 50px;width: 800px;float: left;margin-left: 15px;margin-top: 50px">
    ...
    <a id="used" style="margin-top: 70px;margin-left: 70px;text-decoration: none;color: black">待使用</a>
    <a id="comment" style="margin-top: 70px;margin-left: 70px;text-decoration: none;color: black">待评论</a>
    <a id="shouhou" style="margin-top: 70px;margin-left: 70px;text-decoration: none;color: black">退款售后</a>
</div>
