...
<div style="margin-left: 500px;margin-top: 10px;width: 800px;line-height: 60px;float: left">
    ...
    <h4 style="float: left;height: 30px;margin-left: 580px;text-decoration: none;color: black"><a style="text-decoration: none;color: black" href="insertDish">添加新菜</a></h4>
    <h4 style="float: left;height: 30px;margin-left: 50px;text-decoration: none;color: black"><a style="text-decoration: none;color: black" href="businesscenter">商家中心</a></h4>
