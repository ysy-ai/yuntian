...
<div style="margin-left: 500px;margin-top: 10px;width: 800px;line-height: 60px;float: left">
    ...
    <h4 style="float: left;height: 30px;margin-left: 580px"><a href="jsp/registerDish.jsp">添加新菜</a></h4>
    <h4 style="float: left;height: 30px;margin-left: 50px"><a href="jsp/businessCenter.jsp">商家中心</a></h4>
